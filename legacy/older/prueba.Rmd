...
colores_ext_4 <- rep("#FFFFFF",length(unlist(col_ext_4)))
...
```{r Tortas por cluster, echo=FALSE}

for (i in sort(unique(na.omit(base_agrupada$Cluster_combinado)))){
  tortas(base_agrupada[base_agrupada$Cluster_combinado==i,],paste0("Cluster - ",i))
}
